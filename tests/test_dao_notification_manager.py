...
class TestNotificationManager:
    ...
    def test_retrieve_users_info_ok(self,code, length): ##id femail first name last name  phone nickname lottery_points
        with mock.patch("requests.get") as m:
            m.return_value = MockResponse(code=code, json={"users":[
                {"id":1,"email":"email@email.com","firstname":"name","lastname":"name","phone":123456789,
                "nickname":"nick","lottery_points":1},
                {"id":2,"email":"email1@email1.com","firstname":"name1","lastname":"name1","phone":134256789,
                "nickname":"nick1","lottery_points":2}
            ]})
    ...
    def test_retrieve_by_id(self):
        ...
        db.session.add(notify_lottery)
        db.session.commit()
        with mock.patch("mib.dao.notification_manager.NotificationManager.retrieve_users_info") as m:
            m.return_value = {
                1:{"email":"email@email.com","firstname":"name","lastname":"name","phone":123456789,
                "nickname":"nick","lottery_points":1},
                2:{"email":"email1@email1.com","firstname":"name1","lastname":"name1","phone":134256789,
                "nickname":"nick1","lottery_points":2}
            }
